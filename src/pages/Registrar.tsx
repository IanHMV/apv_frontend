    ...
    <>
      ...
      <div className='bg-white mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl '>
        ...
        <form action="" onSubmit={handleSubmit}>
          ...
          <div className='my-5'>
            <label className='uppercase text-gray-600 block text-xl font-bold' htmlFor="repetir-password">
              Repetir Password
            </label>
            <input 
              className='border w-full p-3 mt-3 bg-gray-50 rounded' 
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setRepetirPassword(e.target.value)} 
            />
          </div>
